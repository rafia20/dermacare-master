...
// import { Searchbar, Card, Button, Text, Divider, IconButton } from 'react-native-paper';
...
// // Array of dermatological conditions for demonstration
// // Include image paths for actual usage
...
//     // UseEffect for mounting and animation logic
//     useEffect(() => {
...
//         const filtered = query ? dummyDiseases.filter(disease => disease.name.toLowerCase().includes(query.toLowerCase())) : dummyDiseases;
...
//                     The Disease Search Library contains information about diseases, including symptoms and treatments, sourced from a dermatologist's book.
//                 </Text>
//             </Animated.View>
//             <Searchbar
...
//                     <Card key={disease.id} style={styles.diseaseCard}>
//                         <Card.Title title={disease.name} left={(props) => <IconButton {...props} icon="folder" />} />
//                         <Card.Content>
//                             <Text style={styles.imageLabel}>Disease Image:</Text>
//                             <Card.Cover source={{ uri: disease.image }} style={styles.diseaseImage} />
//                         </Card.Content>
//                         <Card.Actions>
//                             <Button icon="chat" mode="contained" onPress={() => navigation.navigate("Chat with AI")}>
//                                 Chat your query with AI
//                             </Button>
//                         </Card.Actions>
//                     </Card>
//                 ))}
